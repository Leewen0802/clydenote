...
class Config(object):
    ...
    listAppType = [
        'CHROMEOS\t2.1.5\tChromes\t11.2.5',
        'DESKTOPWIN\t5.9.2\tDesktopWin\t11.2.5',
        'DESKTOPMAC\t5.9.2\tDesktopMac\t11.2.5',
        'IOSIPAD\t8.11.0\tIosIpad\t11.2.5',
        'WIN10\t5.5.5\tWin10\t11.2.5'
    ]
    listAppVer = [
        '2.1.5',
        '5.9.2',
